...
compare_orbit3(t, t_it, t, tob[0:minute_steps, 0], obs[0:steps, 0], scheme.x[0:minute_steps, 0], 'true_orbit', 'observed', 'initial value')
compare_orbit(t, t, tob[0:minute_steps, 0], scheme.x[0:minute_steps,0], 'true_orbit', 'assimilated')
...
compare_orbit3(t, t, t_it, tob[0:minute_steps, 0], scheme.x[0:minute_steps,0], obs[0:steps, 0], 'true orbit', 'assimilated', 'observed')
