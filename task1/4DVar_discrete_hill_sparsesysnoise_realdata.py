...
#%%
class Adjoint:
    def __init__(self, dx, dla, dxi, dnu, N, M, T, dt, it, sysnoise_it, obs_variance, sysnoise_variance, u, x, y, la, xi, nu, q):
        self.dx = dx
        self.dla = dla
        self.dxi = dxi
        self.dnu = dnu
...
ctrl = cos
data = "/Users/konta/Documents/journal/sysbio/experimental_data_Tsuchiya_et_al.codeconverted.extracted.csv"
...
obs = np.loadtxt(data, delim=",", usecols=(11), ndmin=2) #c-Jun

obs_t = np.loadtxt(data, delim=",", usecols=(0), ndmin=2) #c-Jun

u = np.loadtxt(data, delim=",", usecols=(1), ndmin=2) #c-Jun
